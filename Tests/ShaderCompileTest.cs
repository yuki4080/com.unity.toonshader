...
namespace Unity.UniverselToonShader.Urp.Tests {
    public class ShaderCompileTest
    {
        
        [Test]
        public void CompileAllToonShadersDefault() {
            string[] guids = AssetDatabase.FindAssets("t:Shader", new[] {"Packages/com.unity.universaltoonshader.urp/Runtime/Shaders"});
